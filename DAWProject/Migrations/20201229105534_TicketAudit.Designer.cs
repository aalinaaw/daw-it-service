...
namespace DAWProject.Migrations
{
    ...
    [Migration("20201229105534_TicketAudit")]
    partial class TicketAudit
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAWProject.Models.TicketAuditEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DAWProject.Models.TicketAuditEntry", b =>
                {
                    b.HasOne("DAWProject.Models.Ticket", "Ticket")
                        .WithOne("TicketAuditEntry")
                        .HasForeignKey("DAWProject.Models.TicketAuditEntry", "TicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
